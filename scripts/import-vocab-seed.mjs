/**
 * Vocab Seed Import Script
 * Imports 6000 vocabulary rows from auraenglish_vocab_seed_6000_import.jsonl
 * into MongoDB, skipping any words that already exist (upsert by normalizedText).
 * Usage: node scripts/import-vocab-seed.mjs
 */
...
const JSONL_PATH = path.resolve(__dirname, '../../vocab/auraenglish_vocab_seed_6000_import.jsonl');
...
function mapRowToDocument(row) {
  // Build forms array from JSONL forms field (array of strings)
  ...
  // Build meanings - keep TODO as placeholder but mark for review
...
async function main() {
  ...
  async function flushBatch() {
    ...
    // Extract normalizedTexts from this batch
