/**
 * Vocab Seed Import Script — 8000 Additional after 12000
 * Imports 8000 vocabulary rows from auraenglish_vocab_seed_8000_additional_after_12000_import (1).jsonl
 * into MongoDB, skipping any words that already exist (upsert by normalizedText).
 * Usage: node scripts/import-vocab-seed-8000.mjs
 */
...
const JSONL_PATH = 'd:/code/Englist_project/vob/auraenglish_vocab_seed_8000_additional_after_12000_import (1).jsonl';
